...
{
    protected $policies = [
        \App\Containers\AppSection\Post\Models\Post::class => \App\Containers\AppSection\Post\Policies\PostPolicy::class,
        \App\Containers\AppSection\User\Models\User::class => \App\Containers\AppSection\User\Policies\UserPolicy::class,
    ];
